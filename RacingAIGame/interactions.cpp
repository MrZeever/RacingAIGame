...
bool PixelPerfectTest(entity& ent1, entity& ent2, sf::Uint8 AlphaLimit) {
    sf::FloatRect Intersection;
    sf::Sprite Object1 = ent1.return_sprite();
    sf::Sprite Object2 = ent2.return_sprite();
...
bool is_interacting(const entity& et1, const entity& et2) {
    auto box1 = et1.get_bounding_box();
    auto box2 = et2.get_bounding_box();
    return box1.intersects(box2);
}

void is_car_on_track(car& c, track& t) {
    if (!PixelPerfectTest(c, t)) {
        std::cout << "You died" << '\n';
        std::cout << "At pos: " << c.get_pos().x << " " << c.get_pos().y << '\n';
    }
}